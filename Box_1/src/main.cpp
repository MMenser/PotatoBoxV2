...
const char* THINGSPEAK_API_KEY = "YWD5EAS53P91TXJI";
...
const float ambientOffsetC = 0.15;
const float temp1OffsetC = 2.20;
const float temp2OffsetC = 3.20;
const float temp3OffsetC = 0.20;
const float temp4OffsetC = 4.62;
